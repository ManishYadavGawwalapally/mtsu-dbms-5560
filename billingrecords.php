...
// Fetch billing records from billing table
$query = "SELECT billingid, billingdate, billingtime, discharge_date, discharge_time FROM billing WHERE patientid = ?";
$stmt = $conn->prepare($query);
...
<body>
    ...
    <div class="main-content">
        <h1 class="page-title">Your Billing Records</h1>
        ...
        <table class="records-table">
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($row['billingdate']); ?></td>
                    <td><?php echo htmlspecialchars($row['billingtime']); ?></td>
                    <td><?php echo htmlspecialchars($row['discharge_date']); ?></td>
                    <td><?php echo htmlspecialchars($row['discharge_time']); ?></td>
                </tr>
            <?php } ?>
        </table>
    </div>
