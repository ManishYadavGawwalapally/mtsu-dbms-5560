...
// patient prescription records page
...
$query = "SELECT * FROM prescription_records WHERE prescription_id IN 
          (SELECT prescription_id FROM treatment_records WHERE patientid = ?)";
$stmt = $conn->prepare($query);
...
<body>
    ...
    <div class="main-content">
        <h1 class="page-title">Your Prescription Records</h1>
